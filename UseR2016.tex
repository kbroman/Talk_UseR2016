...
\note{
  ...
  good diagnostics data visualizations, and it seems to work.
}
...
\note{
  This is the stupidest code ever. See more discussion at
  {\tt https://kbroman.wordpress.com/2011/08/17/the-stupidest-r-code-ever/}
}
\end{frame}
